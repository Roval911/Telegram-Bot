...
from extensions import ConvertoinException, Converter
...
def convert(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise ConvertoinException('слишком много параметров')

        quote, base, amount = values
        total_base = Converter.get_convert(quote, base, amount)
